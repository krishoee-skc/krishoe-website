...
## 🏭🛍️ हाम्रा दुई भाग — Production र खरिद-बिक्री

KRISHOE ले **दुई किसिमको काम** गर्छ। App ले दुवैलाई अलग-अलग हिसाब गर्छ:

| | **Production (आफै बनाउने)** | **खरिद-बिक्री (किनेर बेच्ने)** |
|---|---|---|
| **किन्ने** | Raw material (छाला, सोल, गम) | Trading goods (बनिबनाउ स्लिपर) |
| **लागत कसरी गनिन्छ** | माल + ज्याला + overhead | **किनेको दर नै लागत** |
| **Stock** | Production batch → finished stock | किन्नासाथ finished stock |
| **बेच्ने** | POS / Online (उही) | POS / Online (उही) |

**बेच्ने बाटो एउटै हो** — फरक खाली लागत गन्ने तरिका।

**नाफा कसरी निस्कन्छ (खरिद-बिक्री):**
> ६० जोर **रु ५००** मा किन्नुभयो → १० जोर **रु ८००** मा बेच्नुभयो
> लागत रु ५,००० → **नाफा रु ३,०००** (३७.५%)

- **छुट र कर पनि लागतमै जोडिन्छ** — बैंकबाट गएको पैसा नै साँचो लागत
- **फरक दरमा किन्दा औसत** — ९० जोर ५०० मा + १० जोर ९०० मा = प्रति जोर **५४०**
  (जोरको हिसाबले, invoice गनेर होइन)
- **नबिकेको माल घाटा होइन** — पैसा stock मा छ, बेचेपछि मात्र लागत गनिन्छ

**Costing page मा हेर्नुहोस्:**
- **Material purchase** — कारखानाको कच्चा माल मात्र
- **Trading goods purchase** — बेच्न किनेको जुत्ता (अलग्गै)
- हरेक design मा **Source**: `Made` / `Bought` / `Made + bought`

> एउटै design आफै पनि बनाउने र किन्ने पनि गर्नुभयो भने, App ले दुवै जोडेर
> औसत लागत निकाल्छ — किनकि पसलमा जोर एउटै ठाउँबाट बिक्छ।
