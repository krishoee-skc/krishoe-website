    ...
    <main className="bg-[#F5F7F4]">
      ...
      <section className="mx-auto grid max-w-7xl gap-10 px-5 py-16 md:grid-cols-[0.9fr_1.1fr] md:px-8">
        <div>
          ...
          <p className="mt-5 text-base leading-8 text-[#5F6B66]">
          ...
          <div className="mt-8 grid gap-4">
            {[
              ...
              <div key={label} className="rounded-lg border border-black/10 bg-white p-5">
                <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#B98A2E]">{label}</p>
                <p className="mt-2 text-lg font-black text-[#10231D]">{value}</p>
              </div>
            ))}
          </div>
        </div>
