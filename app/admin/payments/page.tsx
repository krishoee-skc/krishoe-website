      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <p className="text-[11px] font-black uppercase tracking-[0.2em] text-brand-gold-deep">
            <T en="Payments" ne="भुक्तानी" />
          </p>
          <h1 className="mt-2 font-display text-3xl font-black leading-tight text-brand-green-ink"><T en="Payment reconciliation" ne="भुक्तानी मिलाउने" /></h1>
