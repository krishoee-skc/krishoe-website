...
export const textareaClass =
  "min-h-20 rounded-md border border-gray-200 px-3 py-2 text-sm outline-none focus:border-[#0B4D3B]";
export const compactInputClass =
  "h-9 rounded-md border border-gray-200 px-2 text-xs outline-none focus:border-[#0B4D3B]";
...
export function SubmitActionButton({ label }: { label: string }) {
  return (
    <button
      type="submit"
      className="h-10 rounded-full bg-[#0B4D3B] px-4 text-sm font-bold text-white transition hover:bg-[#D4AF37] hover:text-[#10231D]"
    >
      {label}
    </button>
  );
...
export function SaveButton({ label = "Save" }: { label?: string }) {
  return (
    <button
      type="submit"
      className="h-9 rounded-full bg-[#10231D] px-3 text-xs font-bold text-white transition hover:bg-[#D4AF37] hover:text-[#10231D]"
    >
      {label}
    </button>
  );
