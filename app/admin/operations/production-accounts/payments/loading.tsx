...
/**
 * Held while the payments screen's data arrives.
 *
 ...
 */
export default function AdminOperationsProductionAccountsPaymentsLoading() {
  return <PageSkeleton cards={0} rows={10} />;
}
