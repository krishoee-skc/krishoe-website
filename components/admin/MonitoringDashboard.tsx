...
import {
  ...
  minutesAgo,
  type MonitoringData,
} from "@/components/admin/monitoring-readings";

// What this screen reads — the shape the API sends, and the two functions
// that turn a number and a timestamp into words — lives in
// monitoring-readings.ts beside it. This file draws it.
